...
<p align="center">
  <img src="./images/CaseManagement.png" width="400"/>
  <img src="./images/CaseManagement2.png" width="400"/>
</p>
...
- 대민/대내 시스템 통합으로 업무 효율성 증가
- 배포 자동화를 통한 운영 효율 향상
- 데이터 기반 서비스 안정적 운영 지원

---

## 💡 Insight

- 대규모 공공 데이터 시스템에서의 **ETL 설계 및 운영 경험 확보**
- 데이터 흐름(ETL) + 서비스(웹)를 연결하는 **End-to-End 개발 역량 강화**
- 사용자 중심 화면 설계부터 운영까지 **전 주기 경험 확보**
