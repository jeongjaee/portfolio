...
특히 단독 프로젝트 수행과 실시간 모니터링 시스템 구축을 통해  
**안정적인 서비스 운영과 운영 효율 개선**에 강점을 가지고 있습니다.
...
- 실시간 설비 및 발전량 모니터링 시스템 구축
- 외부 API(KPX / TIS) 연계 데이터 자동 수집
- 운영 및 장애 대응 프로세스 개선
...
- Spring Boot 기반 대내 시스템 구축 및 기능 개발  
👉 운영 환경 안정화 및 업무 프로세스 개선
